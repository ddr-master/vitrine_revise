            ...
            <div id="page-inner">
                <div class="row">
                  ...
                  <?php
                            ...
                            $likes = $bdd->prepare('SELECT * FROM partenaire WHERE meilleur=1 AND confirme = 1');           
                 ...
                 <!-- /. ROW  -->
                 <a class="btn btn-primary" href="confirmer.php">Ajouter d'autre partenaire</a>
                 <hr />
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php 
$con = $bdd ->prepare('SELECT * FROM partenaire WHERE meilleur=1 AND confirme = 1');
  $con->execute(array($getid));
          ...
          ?>
                              ...
                              <tr class="odd gradeX">
                                <td><?php echo $userinfo['id']; ?></td>
                                            ...
                                            <td><?php 
                                              $confirme= $userinfo['meilleur'];
                                                  if ($confirme == 1) { ?>
                                                   <a href="meilleur_partenaire.php?confirm=<?= $userinfo['id']; ?>"type="button" class="btn btn-danger">Enlever</a>
                                                 <?php  }  ?>
                                               </td>
                                        </tr>
