            ...
            <div id="page-inner">
                <div class="row">
                  <?php
                            ...
                            $likes = $bdd->prepare('SELECT * FROM partenaire WHERE confirme = 1');           
           ...
           ?>
                              ...
                              <tr class="odd gradeX">
                                <td><?php echo $userinfo['id']; ?></td>
                                            ...
                                            <td></td>
<td><a href="partenaire_en_ligne.php?supprimer=<?= $userinfo['id']; ?>" type="button" class="btn btn-danger">Supprimer</a></td>
