...
if (isset($_POST['newnom']) AND !empty($_POST['newnom']) AND $_POST['newnom'] != $userinfo['nom_bloc'])
{ 
  $newnom = htmlspecialchars($_POST['newnom']);
  $insertnom = $bdd->prepare("UPDATE bloc SET nom_bloc = ? WHERE id = ?");
...
<head>
    ...
    <title>Modifier bloc | vitrine</title>
	<!-- BOOTSTRAP STYLES-->
                                ...
                                <div class="col-md-6">
                                    ...
                                    <form role="form" action="#" method="POST">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="newnom" value="<?php echo $userinfo['nom_bloc']; ?>" />
                                        </div>
