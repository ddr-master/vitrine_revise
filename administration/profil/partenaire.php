...
<head>
    ...
    <title>Liste de tout les comptes partenaires</title>
	<!-- BOOTSTRAP STYLES-->
            ...
            <div id="page-inner">
                <div class="row">
                  <?php
                            ...
                            $likes = $bdd->prepare('SELECT * FROM utilisateurs');           
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php 
$con = $bdd ->prepare('SELECT * FROM utilisateurs ORDER BY date DESC');
  $con->execute(array($getid));
           ...
           ?>
                              ...
                              <tr class="odd gradeX">
                                <td><?php echo $userinfo['id']; ?></td>
                                            ...
                                            <td><?php echo $userinfo['telephone']; ?>
                                            </td>

                                            <td><?php echo $userinfo['email']; ?></td>
                                            <td><?php echo $userinfo['date']; ?></td>
                                            <td><a href="partenaire.php?supprimer=<?= $userinfo['id']; ?>" type="button" class="btn btn-danger">Supprimer</a></td>
                                        </tr>
