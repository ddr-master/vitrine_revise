            ...
            <div id="page-inner">
                <div class="row">
                  <?php
                            ...
                            $likes = $bdd->prepare('SELECT * FROM partenaire WHERE confirme = 0');           
                            $likes->execute(array($getid));
                        $likes = $likes->rowCount();
                             ?>
                    <div class="col-md-12">
                     <h2>Liste de tout les comptes partenaires en attente(<?php echo $likes ?>)</h2>   
           ...
           ?>
                              ...
                              <tr class="odd gradeX">
                                <td><?php echo $userinfo['id']; ?></td>
                                            ...
                                            <td></td>
<td><a href="partenaire_en_attente.php?supprimer=<?= $userinfo['id']; ?>" type="button" class="btn btn-danger">Supprimer</a></td>
                                            <td><a href="details.php?id=<?= $userinfo['id']; ?>" type="button" class="btn btn-success">En attente ...</a></td>
                                        </tr>
